...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="messages" style="height:88vh; overflow:auto;">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (let message in response) {
                        console.log(message);
                        if (message.senderID == $("#sender-username").text()) {
                    ...
                    //alert(html);
                    let areaToInsert = $('.messages');
                    areaToInsert.innerHTML = html;
                    areaToInsert.scrollTop = areaToInsert.scrollHeight;

                    // let res = JSON.parse(response);
                    // let html = res.reverse().map(function(message) {
                    // return `
                    //     <div class="message">
                    //     <span class="content">${message.contents}</span>
                    //     </div>
                    // `
                    // }).join('');
